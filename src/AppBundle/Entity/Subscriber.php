...
class Subscriber
{
    ...
    /**
     * @var int
     * @Assert\NotBlank (message="Complete Education Level field")
     ...
     * @var bool
     *
     * @Assert\NotBlank (message ="You must agree to SmartEduPics.com Terms & Conditions")
    ...
    /**
     * @var bool
     * @Assert\NotBlank (message ="You must agree to recieve notifications from SmartEduPics.com")
     ...
     * @var bool
     *
     * @Assert\NotBlank (message ="You must agree to recieve notifications from partners of SmartEduPics.com")
