...
class FrontEndController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        try{
            ...
            if($form1->isValid() && $form1->isSubmitted())
            {
                ...
                $educationlevelid = $form1['educationlevelid']->getData();
                ...
                if(!$exsSubscriber) {
                    ...
                    $newSubscriber ->setEducationlevelid($educationlevelid);
                    ...
                    $newOptInDetails ->setResourceid(2);
                    ...
                    $isopted = $em ->getRepository('AppBundle:SubscriberOptInDetails') ->findOneBy(['user' => $userid, 'resourceid' => 2]);
                    if(!$isopted) {
                ...
                $message = Swift_Message::newInstance()
                    ...
                    ->setFrom(['support@smartedupics.com' => 'SmartEduPics Support Team'])
    ...
    public function unsubscribeAction(Request $request) {   
        ...
        if($form->isValid() && $form->isSubmitted()) {
            ...
            if($subscriber) {
                    ...
                    $message = Swift_Message::newInstance()
                        ->setSubject('SmartEduPics.com | We are sorry you are leaving us')
                        ->setFrom(['support@smartedupics.com' => 'SmartEduPics Support Team'])
    ...
    */
    ...
    private function generateEmailUrl($url) {
        return "http://smartedupics.mediaff.com" . $this->container->get('router')->getContext()->getBaseUrl() . $url;
    }
}